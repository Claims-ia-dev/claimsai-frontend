...
const PdfComponent = ({customer_info,rooms, totalCost, logo }) => {
  ...
  const handleDownloadPDF = () => {
    ...
    // Total Cost
    doc.text(`The estimated amount for this project is: $${totalCost.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`, margin, doc.autoTable.previous.finalY + 20, { align: 'left' });
